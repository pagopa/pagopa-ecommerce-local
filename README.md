...
In case of errors starting up Mongo blaming against replicas key (cannot read key etc) generate a fresh new replicas key with the following commands


```sh
cd mongodb
openssl rand -base64 758 > replica.key 
```