...
// idempotency: only insert data if the collection is empty
if (db.getCollection('transactions-view').countDocuments() > 0) {
    print("Data already exists in 'transactions-view'. Skipping data seeding.");
} else {
